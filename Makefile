OBJECTIVE-C_VERSION := $(shell cat OBJECTIVE-C_VERSION)
OBJECTIVE-C_DEPS := $(wildcard OBJECTIVE-C_*)
DOCKER_TAG_PREFIX := rzuckerm/objective-c:$(OBJECTIVE-C_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(OBJECTIVE-C_DEPS)
